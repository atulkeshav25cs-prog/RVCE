    ...
    <div className="min-h-screen bg-[#F4F5F7] font-sans">
      ...
      <div className="bg-[#003366] text-white py-10 border-b-4 border-amber-500">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <h1 className="text-4xl lg:text-5xl font-bold tracking-tight mb-3">National Citizen Services Directory</h1>
          <p className="text-blue-100 text-lg font-medium">Official Standard Operating Procedures & Guidelines</p>
        </div>
      </div>

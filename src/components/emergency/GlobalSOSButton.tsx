...
export default function GlobalSOSButton({ isLoggedIn = false }: GlobalSOSButtonProps) {
  ...
  return (
    <>
      <button
        onClick={handleClick}
        className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-16 h-16 bg-red-600 text-white rounded-full shadow-2xl hover:bg-red-700 hover:scale-105 active:scale-95 transition-all animate-pulse shadow-red-500/50 border-4 border-white dark:border-slate-900"
